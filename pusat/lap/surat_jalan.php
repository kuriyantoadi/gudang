            ...
            ?>
					  ...
					  <div class="container">
							<h3 class="mt-4" style="margin-bottom: 30px">
							  <center>Cetak Surat Jalan</center>
							</h3>
							<form action="../../cetak_order.php" method="post">
                ...
                echo "<div class='register-logo'><b>Oops!</b> Data Tidak Lengkap.</div>
								...
								<div class='register-box-body'>
									...
									$query=mysql_query($koneksi, "SELECT * FROM t_order WHERE tgl_kirim  between  '$tanggal_awal' AND '$tanggal_akhir';");
                }
            ?>	
					 </div>
