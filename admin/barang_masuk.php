        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item active">
              <a class="nav-link" href="#">Tampil Stok Barang <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">Input Barang Masuk</a>
            </li>
            <li class="nav-item">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <form action="index.html" method="post">
              <td>
                <input type="number" class="form-control" name="barang_masuk" size="2">
              </td>
