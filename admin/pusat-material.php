...
<div class="container">
    ...
    <form action="update_masuk.php" method="post">
        <a href="pusat-lap-material.php" style="margin-bottom: 30px; margin-right: 10px" type="button" class="btn btn-sm btn-warning" name="button">Laporan Material</a>
