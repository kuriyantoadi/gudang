<?php include('header.php') ?>
            ...
            <div class="container">
                ...
                <table style="margin-top: 50px">
                    <tr>
                        <th width="400px">
                            <center>Pj. Warehouse Jakarta</td>
                        <th width="400px">
                            <center>Pj. Ekspedisi</td>
                        <th width="400px">
                            <center>Pj. Warehouse Pusat</td>
                        <th width="400px">
                            <center>Driver</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <center><?php echo $d['pj_warehouse_pusat'] ?>
                        </td>
                        <td>
                            <center><?php echo $d['pj_ekspedisi'] ?>
                        </td>
                        <td>
                            <center><?php echo $d['pj_warehouse_cbg'] ?>
                        </td>
                        <td>
                            <center><?php echo $d['driver'] ?>
                        </td>
                    </tr>
                </table>
